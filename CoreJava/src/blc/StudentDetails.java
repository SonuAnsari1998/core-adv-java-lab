...
Create another class Test in the same package which is ELC class (contains main method) to test the application.
 Don’t create the Object in the Test class, call the static method getStudentDetails() 
 which should print the Student data in the following format
[ Roll is :101, Name is :Ravi, Fees is :14000.9]

Note :- Both the classes must be declared with public access modifier*/
public class StudentDetails {
	public static String getStudentDetails(int rollNo, String studentName, double fees) {
		return "["+"Roll is :"+rollNo+", Name is :"+studentName+", Fees is :"+fees+"]";
	}
